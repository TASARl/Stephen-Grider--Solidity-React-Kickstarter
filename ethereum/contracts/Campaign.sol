// compile işlemi buradan deploy işlemi remixden. eploy sonrası factory adresi ilgili yere yapıştır.
...
contract CampaignFactory {
    ...
    function createCampaign(uint minimum, string memory metinBaslik) public {
        Campaign newCampaign = new Campaign(minimum, msg.sender, metinBaslik);
...
contract Campaign {
    ...
    string public metinBaslik;
    mapping(address => bool) public approvers;
    uint public approversCount;
    Request[] public requests;

    constructor(uint minimum, address creator, string memory metinBaslik) public {
        manager = creator;
        minimumContribution = minimum;
        metinBaslik = metinBaslik;
    }
